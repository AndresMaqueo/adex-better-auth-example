...
function mergePropsWithDOM(rootNode, props) {
  ...
  function init(){
    if(customElements.get("island-nav-user")){
      return
    }
    customElements.define("island-nav-user", class IslandNavUser extends HTMLElement {
      constructor(){
        super();
      }
    
      async connectedCallback() {
          const c = await import("/Users/sid/lab/timelogs/src/components/nav-user.tsx");
          const usableComponent = c["NavUser"]
