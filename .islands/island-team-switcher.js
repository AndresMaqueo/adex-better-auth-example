...
function mergePropsWithDOM(rootNode, props) {
  ...
  function init(){
    if(customElements.get("island-team-switcher")){
      return
    }
    customElements.define("island-team-switcher", class IslandTeamSwitcher extends HTMLElement {
      constructor(){
        super();
      }
    
      async connectedCallback() {
          const c = await import("/Users/sid/lab/timelogs/src/components/team-switcher.tsx");
          const usableComponent = c["TeamSwitcher"]
