...
function mergePropsWithDOM(rootNode, props) {
  ...
  function init(){
    if(customElements.get("island-nav-main")){
      return
    }
    customElements.define("island-nav-main", class IslandNavMain extends HTMLElement {
      constructor(){
        super();
      }
    
      async connectedCallback() {
          const c = await import("/Users/sid/lab/timelogs/src/components/nav-main.tsx");
          const usableComponent = c["NavMain"]
