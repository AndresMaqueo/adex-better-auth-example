...
function mergePropsWithDOM(rootNode, props) {
  ...
  function init(){
    if(customElements.get("island-nav-projects")){
      return
    }
    customElements.define("island-nav-projects", class IslandNavProjects extends HTMLElement {
      constructor(){
        super();
      }
    
      async connectedCallback() {
          const c = await import("/Users/sid/lab/timelogs/src/components/nav-projects.tsx");
          const usableComponent = c["NavProjects"]
